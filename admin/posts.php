...
<?php
  ...
  if (!empty($category_id)){
      ...
      $sel_qur_posts   = "select * from posts  order by id DESC";
...
?>
                ...
                <tr>
                    ...
                    <td style="width: 20%;" class="post_desc"><?php echo shorten($sel_data_post['description'],80); ?></td>
                    ...
                    <td style="width: 10%;"  ><?php echo $sel_data_post['downloads']; ?></td>
