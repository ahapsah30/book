...
$id = $_GET['id'];
  ...
  $sel_qur = "select * from category where id = '" . $id . "'";
            ...
            <div class="col-sm-12">
              ...
              <div class="card">
                <div class="card-body cat-card-body">
                  ...
                  <form role="form" method="post" action="category-actions.php?id=<?php echo $id ?>" enctype="multipart/form-data">
                    ...
                    <div class="row form-group category-table">
                      <div class="col col-12 col-sm-7">
                        <input type="submit" class="btn btn-theme cate-btn text-light" id="cat_insert" name="cat_edit" value="Update Category">
                      </div>
                    </div>
                  </form>
