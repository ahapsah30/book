...
<body  style="background-color:#606E82" >
    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-logo text-light"  style="margin-top:18px; margin-bottom:18px;" align="center" > <h4>Books4u</h4> </div>
...
{       
    ...
    $query = "select * from admin where username = '$em' and password = '$pass' ";
